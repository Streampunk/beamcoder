...
export interface CodecContextBaseMin {
	/** Object name. */
	readonly type: 'decoder' | 'encoder'; // string
	/** see AV_CODEC_ID_xxx */
   ...
   */
	 ...
	 */
	  ...
	  */
	 hw_device_ctx: HWDeviceContext | null
 	// private field
	 readonly _CodecContext: {};
}
export interface CodecContext_base extends CodecContextBaseMin {
 	/**
	...
	request_channel_layout: string | 'default'
...
export interface CodecContext extends CodecContext_base {
	/**
